...
def run_dual_stochastic_heatmap():
    ...
    # Tracé 1
    _ = axes[0].imshow(z1, origin="lower", extent=ext, aspect="auto", cmap="RdYlGn")
    axes[0].set_title(
        "Scénario A : Abattement successoral consommé\n"
    ...
    # Tracé 2
    im2 = axes[1].imshow(z2, origin="lower", extent=ext, aspect="auto", cmap="RdYlGn")
    axes[1].set_title(
        "Scénario B : Abattement successoral disponible\n"
    ...
    output_path = os.path.join(
        os.path.dirname(__file__), "../images/stochastic_dual_scenario.png"
    )
