...
Ce dépôt compare la fiscalité du CTO (Compte Titres) et de l’AV (Assurance Vie) via plusieurs scénarios et la mise à disposition d'un simulateur, avec une UI disponible dans votre navigateur et des simulations Python pour reproduire les images disponibles dans le post original. 
